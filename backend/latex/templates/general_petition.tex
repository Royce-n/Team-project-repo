...
\usepackage[top=1.2in,bottom=0.75in,left=0.75in,right=0.75in]{geometry}
\usepackage{graphicx}
\usepackage{array}
\usepackage{fancyhdr}
\usepackage{tabularx}
...
\fancyhead[R]{\includegraphics[height=0.5in]{../templates/uh_logo.png}}
...
& \small Last \hspace{1.8in} First \\[0.15in]
...
\ifthenelse{\equal{{{HAS_STUDENT_SIGNATURE}}}{true}}{%
  \raisebox{-0.3in}{\includegraphics[height=0.5in,keepaspectratio]{{{STUDENT_SIGNATURE_PATH}}}}%
}{%
  \underline{\hspace{3in}}%
} \textbf{Date} \underline{{{SUBMISSION_DATE}}\hspace{1in}}
